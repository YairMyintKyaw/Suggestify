const Feedback = () => {
  return (
    <div
      className="flex lg:flex-row flex-col  items-center py-28 px-10 border-b border-darkGreen bg-darkGreen"
      id="feedback"
    >
      ...
      <div className="flex-1  ">
        <h2 className=" text-7xl font-helvetica_compressed mb-5 tracking-wide toUp">
          Give Feedback to us
        </h2>
